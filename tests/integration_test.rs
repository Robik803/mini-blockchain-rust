...
use mini_blockchain::accounts::*;
use mini_blockchain::keys::*;
use mini_blockchain::ledger::*;
use mini_blockchain::transactions::*;
use mini_blockchain::instructions::*;

#[test]
fn test_full_ledger_flow() {
    let password = "password123";
    let (mut alice, alice_path) = Account::new(password).unwrap();
